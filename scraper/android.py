...
class Android:
    ...
    def scrap_result_row(self, div):
        ...
        self.mdb.add_vacancy_android(title, location, salary, summary)

    def scrap_android_developer(self, url):

        print "\nScrapping android Developer: %s \n" % url
...
if __name__ == '__main__':
    android = Android()
    android.scrap_android_developer()
